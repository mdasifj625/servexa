...
*User Login -> Token Generated -> Protected Dashboard Accessed -> Module Selected (e.g., Work Orders) -> API Request Sent -> Data Rendered in React Table.*
...
*(In the physical printout of this report, insert screenshots under these headings)*
